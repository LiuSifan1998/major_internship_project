...
def type_transformer(transformer_name,classifier_name,file_train,file_test):
    ...
    if transformer_name == 'bert':
        output_file = '/projects/qbio/bifo/ProtProduction/khld071/protransbert_output/final_model/score/score4final' + classifier_name + '.csv'
    if transformer_name == 'xl':
        output_file = '/projects/qbio/bifo/ProtProduction/khld071/protransxl_output/final_model/score/score4final' + classifier_name + '.csv'
    if transformer_name == 'xlnet':
        output_file = '/projects/qbio/bifo/ProtProduction/khld071/protransxlnet_output/final_model/score/score4final' + classifier_name + '.csv'
...
sub_df = df.sample(frac=1.0).reset_index(drop=True)
