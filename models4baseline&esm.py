...
def type_transformer(transformer_name,classifier_name,file_train,file_test):
    ...
    if transformer_name == 'baseline':
        output_file = '/projects/qbio/bifo/ProtProduction/khld071/order_encode_output/final_model/score4final' + classifier_name + '.csv'
    if transformer_name == 'esm':
        output_file = '/projects/qbio/bifo/ProtProduction/khld071/esm_output/final_model/scores/score4final' + classifier_name + '.csv'
